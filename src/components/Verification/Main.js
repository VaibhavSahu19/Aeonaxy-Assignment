...
function Main() {
  return (
    <section className='flex flex-col justify-center items-center gap-[10px] text-[roboto] my-[40px] px-[10%] sm:px-[0%] text-center'>
        ...
        <p className='text-gray-500 text-sm font-medium sm:px-[27%] text-center'>Didn't receive the email? Check your Spam folder, it may have been caught by a filter. If you still don't see it, you can <a className='text-[#EB4B8B] font-bold' href=''>resent the confirmation email.</a></p>
