    ...
    <section className='flex flex-col m-[20px] font-[roboto] justify-center'>
        ...
        <div className='flex flex-col justify-center items-center text-center py-[20px]'>
            ...
            <div className='flex flex-col sm:flex-row mt-[80px] gap-[70px] md:gap-[20px] text-center justify-center items-top w-[70%]'>
                <div className={`relative flex flex-col justify-center items-center border-[2px] rounded-[10px] gap-[10px] h-[auto] w-[100%] md:h-[350px] md:w-[280px] cursor-pointer ${isImage1Clicked ? 'border-[#Eb4B8B]' : ''} py-[10px]`} onClick={() => handleClick(1)}>
                    <img className={`w-[100%] h-auto ${isImage1Clicked ? 'absolute -top-1/4' : ''} `} src={Image1} alt='Option 3' />
                ...
                <div className={`relative flex flex-col justify-center items-center border-[2px] rounded-[10px] gap-[10px] h-[auto] w-[100%] md:h-[350px] md:w-[280px] cursor-pointer ${isImage2Clicked ? 'border-[#Eb4B8B]' : ''} py-[10px]`} onClick={() => handleClick(2)}>
                ...
                <div className={`relative flex flex-col justify-center items-center border-[2px] rounded-[10px] gap-[10px] h-[auto] w-[100%] md:h-[350px] md:w-[280px] cursor-pointer ${isImage3Clicked ? 'border-[#Eb4B8B]' : ''} py-[10px]`} onClick={() => handleClick(3)}>
