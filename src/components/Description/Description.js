  ...
  return (
    <section className='flex flex-col m-[20px] font-[roboto]'>
        ...
        <div className='flex flex-col justify-center items-center  text-center py-[20px]'>
            ...
            <div className='flex mt-[80px] gap-[20px] text-center justify-center items-top w-[70%]'>
                <div className={`relative flex flex-col justify-center items-center border-[2px] rounded-[10px] gap-[10px] h-[350px] w-[280px] cursor-pointer ${isImage1Clicked ? 'border-[#Eb4B8B]' : ''} py-[10px]`} onClick={() => handleClick(1)}>
